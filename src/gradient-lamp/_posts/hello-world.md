...
carouselImages:
    - "/assets/blog/hello-world/test1.png"
    - "/assets/blog/hello-world/test2.png"
    - "/assets/blog/hello-world/test3.png"
    - "/assets/blog/hello-world/test4.png"
inlineImages:
    - "/assets/blog/hello-world/pol.svg"
    -  "/assets/blog/hello-world/color.gif"
    - "/assets/blog/hello-world/mask.gif"
---
...
INLINE_IMAGES_HERE("PLMs are made from stacking one or more pieces of clear cellophane together and sandwiching them between two polarizers. One can create multicolored designs by arranging stacks of different thicknesses.")
...
INLINE_IMAGES_HERE("Performing color-to-color transitions by rotating either the mosaics or the polarizers in tandem.")

INLINE_IMAGES_HERE("Changing the visibility of the arrow-shaped masking layer by adjusting its orientation relative to the analyzer.")
